...
dh_params_sym = [
    ...
    [q2, 0, l2, 180],   # se cambiaron tanto los ángulos q1, q2, las distancias a se quedaron en 0, la distancia l se cambio tanto l1 y l2 y el angulo alpha se agino el valor de pi/2 y 0 para los demas casos
    [0, d3, 0, 0],   #se agrega la siguiente linea para la articulacion 3 
]
